$(document).ready(function(){
 ...
 /* effect: "fade",  fade 효과 */
    ...
    navigation: {  /* 이전, 다음 버튼 */
      nextEl: '.button-next',  /* 다음 버튼의 클래스명 */
      prevEl: '.button-prev',  
    },
  ...
  /* 
    ...
    1. class명을 조정해서 상태에 따라 완전히 선택자를 다르게 할 수 있게 함
       이벤트를 두번 주는 경우
  ...
  */
  $('.popup .btn_stop').on('click', function(){
    if($(this).hasClass('play') == true){ //만약에 현재 play 클래스를 가지고 있다면(일시정지중)
  ...
  /*
    swiper를 하나의 페이지에 여러개 적용하는 경우 반드시 const swiper의 이름을 변경해야함
  */
